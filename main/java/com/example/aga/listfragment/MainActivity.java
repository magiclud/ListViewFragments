...
public class MainActivity extends ActionBarActivity implements FragmentsHandler.OnHeadlineSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getResources().getConfiguration().orientation
            ...
            Log.d("FRAGMENT: ", "ORIENTATION LANDSCAPE");
       }else{
            setListView();
        }
    }
...
private void galleryAddPic() {
    ...
    public void onArticleSelected(int position) {
        ...
        FragmentsBiggerView fragment = (FragmentsBiggerView) getFragmentManager()
                .findFragmentById(R.id.detailFragment);
        fragment.setViewDetails(pictures.get(position));
if(fragment !=null){
    // Make new fragment to show this selection.
    fragment = FragmentsBiggerView.newInstance(position);

    // Execute a transaction, replacing any existing
    // fragment with this one inside the frame.
    FragmentTransaction ft
            = getFragmentManager().beginTransaction();
    ft.replace(R.id.detailFragment, fragment).setTransition(
